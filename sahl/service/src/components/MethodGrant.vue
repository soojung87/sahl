    ...
    methods: {
        ...
        setMethodD(item) {
            if(this.element.methodD != item.name) {
                ...
                //새로 추가해준다
                this.newLine(this.element.uuid+'/MethodGD', this.element.uuid+'/MethodGD', item.uuid, false)
        ...
        newMethodD() {
            this.$store.commit('addElementMethodGD', { 
                name: this.$store.getters.getNameMethodGD, path: '', input: false,
        ...
        setProvide(item) {
            if(this.element.provide != item.name) {
                ...
                if (endLine != item.uuid) {
                    this.newLine(this.element.uuid+'/MGProvide', this.element.uuid+'/MGProvide', item.uuid, false)
                }
