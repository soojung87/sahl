    ...
    methods: {
        ...
        setEventD(item) {
            if(this.element.eventD != item.name) {
                ...
                //새로 추가해준다
                this.newLine(this.element.uuid+'/EventGD', this.element.uuid+'/EventGD', item.uuid, false)
        ...
        newEventD() {
            this.$store.commit('addElementEventGD', { 
                name: this.$store.getters.getNameEventGD, path: '', input: false,
        ...
        setProvide(item) {
            if(this.element.provide != item.name) {
                ...
                if (endLine != item.uuid) {
                    this.newLine(this.element.uuid+'/EGProvide', this.element.uuid+'/EGProvide', item.uuid, false)
                }
