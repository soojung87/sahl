            ...
            <v-dialog v-model="dialogText" persistent scrollable width="800">
                <v-card >
                    ...
                    <v-card-text>
                        ...
                        <v-row>
                            <label style="padding:10px;">&#60;INITIAL-OFFER-BEHAVIOR&#62;</label>
                        </v-row>
                        <v-row>
                        ...
                        <v-row>
                            <label style="padding:10px;">&#60;OFFER-CYCLIC-DELAY&#62;</label>
                                <v-text-field v-model="editARXML.offer" placeholder="Time" style="height: 15px;" class="lable-placeholer-color" dense></v-text-field>
                            <label style="padding:10px;">&#60;&#47;OFFER-CYCLIC-DELAY&#62;</label>
                        </v-row>
                        <v-row>
                        ...
                        <v-row>
                            <label style="padding:10px;">&#60;SERVICE-OFFER-TIME-TO-LIVE&#62;</label>
...
export default {
    ...
    data() {
        return {
            ...
            dialogText: false,
            editARXML: {name:'', offer: '', inidelaymax: '', inidelaymin: '', inibasedelay: '', inirepetimax: '', delaymax: '', delaymin: '', timetolive: ''},
        }
    },
    mounted () {
    ...
    methods: {
        ...
        viewARXML() {
            ...
            this.editARXML.offer = this.element.offer
        ...
        saveARXML() {
            if (this.element.name != this.editARXML.name) {
                this.$store.commit('editSomeIPServer', {compo:"Name", uuid:this.element.uuid, name:this.editARXML.name} )
            ...
            this.element.offer = this.editARXML.offer
        ...
        cancelARXML() {
            this.editARXML = {name:'', offer: '', inidelaymax: '', inidelaymin: '', inibasedelay: '', inirepetimax: '', delaymax: '', delaymin: '', timetolive: ''}
