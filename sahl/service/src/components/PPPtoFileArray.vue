    ...
    methods: {
        ...
        setFileArray(item) {
            if(this.element.fileArray != item.name) {
                ...
                this.newLine(this.element.uuid+'/PPPtoFileArray', this.element.uuid+'/PPPtoFileArray', item.uuid, false)
        ...
        newFileArray() {
            this.$store.commit('addElementPERFileArray', { 
                name: this.$store.getters.getNamePERFileArray, path: '', input: false,
        ...
        setPort(item) {
            if(this.element.port != item.name) {
                ...
                if (endLine != item.uuid) {
                    this.newLine(this.element.uuid+'/PPPtoFilePRPort', this.element.uuid+'/PPPtoFilePRPort', item.uuid, false)
                }
        ...
        setProcess(item) {
            if(this.element.process != item.name) {
                ...
                //새로 추가해준다
                this.newLine(this.element.uuid+'/PPPtoFileProcess', this.element.uuid+'/PPPtoFileProcess', item.uuid, false)
