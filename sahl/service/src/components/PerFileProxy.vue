                        ...
                        <v-card-text v-if="iselementOpenClose">
                            ...
                            <v-card outlined class="mx-auto">
                                ...
                                <v-card-text v-if="isFileProxyOpenClose">
                                    <v-data-table v-model="selectDelectFileProxy" :headers="headerFileProxy" :items="element.proxy" :items-per-page='$setNumTableList'
                                            ...
                                            <tbody>
                                                <tr v-for="(item,idx) in items" :key="idx">
                                                    <td v-for="(header,key) in headers" :key="key">
                                                        <v-edit-dialog persistent @open="openFileProxy(idx)" @cancel="cancelFileProxy" @save="editFileProxy(idx)" large >
                                                            {{item[header.value]}}
                                                ...
                                                <tr>
                                                    <th colspan="3">
                                                        <v-edit-dialog  large persistent @cancel="cancelFileProxy" @save="addFileProxy()"> 
