    ...
    methods: {
        ...
        setProcessD(item) {
            if(this.element.processD != item.name) {
                ...
                //새로 추가해준다
                this.newLine(this.element.uuid+'/EGDproD', this.element.uuid+'/EGDproD', item.uuid, false)
        ...
        setSIEvent(item) {
            if(this.element.SIEvent != item.name) {
                ...
                if (endLine != item.uuid) {
                    this.newLine(this.element.uuid+'/EGDserviceI', this.element.uuid+'/EGDserviceI', item.uuid, false)
                }
