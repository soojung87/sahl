    ...
    methods: {
        ...
        setProcessD(item) {
            if(this.element.processD != item.name) {
                ...
                //새로 추가해준다
                this.newLine(this.element.uuid+'/FGDproD', this.element.uuid+'/FGDproD', item.uuid, false)
        ...
        setSIField(item) {
            if(this.element.SIField != item.name) {
                ...
                if (endLine != item.uuid) {
                    this.newLine(this.element.uuid+'/FGDserviceI', this.element.uuid+'/FGDserviceI', item.uuid, false)
                }
